...
public class KubusMain
{
	...
	public void mainLoop()
	{
		...
		Tile t2 = new Tile(0, 1, 0, null, kube, 0);
		Tile t3 = new Tile(1, 0, 0, null, kube, 0);
		Tile t4 = new Tile(1, 1, 0, null, kube, 0);
		...
		while(true)
		{
	//		c.setPosition(c.getPosition().add(new Vector4f(0.01f, 0.01f, 0, 0)));
		//	c.lookAt(new Vector4f(0, 0, 0, 1));
			f.fill((byte)0);
			f.clearDepthBuffer();
